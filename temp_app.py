...
class RepoManagerApp(App):
    ...
    def CSS(self):
        ...
        /* Style different content types in the virtual scroller */
        .user-message {
            color: $primary;
        }
        ...
        #save-theme-btn, #reset-theme-btn {
            margin: 0 0 1 0;
            width: 100%;
        }
    ...
    def __init__(self, theme_name: str = "default"):
        ...
        # Available themes will be set in _register_themes
    ...
    def on_mount(self) -> None:
        ...
        # Initialize virtual scroller with welcome message
        if self.virtual_scroller:
            # Clear any existing content to avoid data structure conflicts
            self.virtual_scroller.content_items.clear()
            self.virtual_scroller.add_text_message(
